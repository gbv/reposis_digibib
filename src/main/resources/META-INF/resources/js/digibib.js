...
$(document).ready(function() {
  ...
  var newHref = window["webApplicationBaseURL"] + 'servlets/solr/select?q=state%3Asubmitted%20AND%20createdby:' + userID + '&fq=objectType:mods';
  $("a[href='"+window["webApplicationBaseURL"]+"servlets/solr/select?q=state%3Asubmitted%20AND%20createdby:USERNAME']").attr('href', newHref);
