...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xalan="http://xml.apache.org/xalan" xmlns:i18n="xalan://org.mycore.services.i18n.MCRTranslation">
  ...
  <xsl:template match="realms">
    <div class="alert alert-warning" role="alert">
      <xsl:value-of select="i18n:translate('digibib.shibbolethError.alert.pre')"/>
      <a href="https://leopard.tu-braunschweig.de/editor/submit_request.xed">
        <xsl:value-of select="i18n:translate('digibib.shibbolethError.alert.form')"/>
      </a>.
      <xsl:value-of select="i18n:translate('digibib.shibbolethError.alert.post')"/>
      <a href="mailto:ub-publikationsservices@tu-braunschweig.de">ub-publikationsservices@tu-braunschweig.de</a>.
    </div>
