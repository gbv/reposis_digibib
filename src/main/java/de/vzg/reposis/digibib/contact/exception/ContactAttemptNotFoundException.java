 ...
 * when a {@link ContactAttempt} is not found.
 */
public class ContactAttemptNotFoundException extends ContactException {

    private static final long serialVersionUID = 1L;

    /**
     * Constructs a new ContactAttemptNotFoundException with a default message and error code.
     */
