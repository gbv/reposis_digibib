...
/**
 * Represents a contact request containing name, email, message, and optional ORCiD.
 */
@Embeddable
public class ContactRequest {
     ...
     */
    public ContactRequest(String name, String email, String message, String orcid) {
        this.name = name;
        this.email = email;
