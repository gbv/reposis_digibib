 ...
 */
public class ContactEmailClient {
     ...
     */
    public ContactEmailClient(Session session) {
     ...
     *
     * @return store
     * @throws ContactEmailException if an error occurs
     */
    public Store getStore() {
        try {
            return mailSession.getStore();
        } catch (MessagingException e) {
            throw new ContactEmailException("Error while returning store", e);
        }
    }
     ...
     * @throws ContactEmailException if cannot send mail
     */
