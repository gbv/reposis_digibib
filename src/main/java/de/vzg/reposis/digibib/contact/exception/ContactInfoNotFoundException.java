 ...
 * when {@link ContactInfo} is not found.
 */
public class ContactInfoNotFoundException extends ContactException {

    private static final long serialVersionUID = 1L;

    /**
     * Constructs a new ContactInfoNotFoundException with a default message and error code.
     */
