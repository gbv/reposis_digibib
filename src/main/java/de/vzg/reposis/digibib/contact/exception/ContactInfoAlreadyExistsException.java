...
/**
 * This class class represents an exception that is thrown
 * when {@link ContactInfo} for {@link ContactTicket} already exists.
 */
public class ContactInfoAlreadyExistsException extends ContactException {

    private static final long serialVersionUID = 1L;

    /**
     * Constructs a new ContactInfoAlreadyExistsException with a default message and error code.
     */
