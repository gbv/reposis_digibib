 ...
 * when a {@link ContactRequest} is invalid.
 */
public class ContactRequestValidationException extends ContactRequestException {
    ...
    /**
     * Constructs a new ContactRequestValidationException with a default message.
     */
    ...
    /**
     * Constructs a new ContactRequestValidationException with the specified message.
     *
    ...
    /**
     * Constructs a new ContactRequestValidationException with the specified throwable.
     *
