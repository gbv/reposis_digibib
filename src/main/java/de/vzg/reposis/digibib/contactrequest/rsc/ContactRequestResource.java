...
/**
 * Provides methods to handle {@link ContactRequestBody}.
 */
...
public class ContactRequestResource {
    ...
    /**
     * Creates new {@link ContactRequest} by {@link ContactRequestBodyDto} for object id.
     *
    ...
    public Response createContactRequest(@QueryParam(QUERY_PARAM_OBJECT_ID) String objectIdString,
        ...
        try {
            ContactRequestServiceImpl.getInstance().createContactRequest(contactRequestDto);
    ...
    public Response confirmContactAttempt(@QueryParam(QUERY_PARAM_ATTEMPT_ID) UUID contactAttemptId) {
        ...
        try {
            ContactAttemptServiceImpl.getInstance().partialUpdateContactAttempt(contactAttemptId, contactAttemptDto);
    ...
    /**
     * Returns status of contact request.
     *
    ...
    public ContactRequestSummaryDto getRequestStatus(@QueryParam(QUERY_PARAM_REQUEST_ID) UUID contactRequestId) {
        ...
        try {
            final ContactRequestSummaryDto contactRequestSummaryDto
                = ContactRequestServiceImpl.getInstance().getStatusSummaryById(contactRequestId);
