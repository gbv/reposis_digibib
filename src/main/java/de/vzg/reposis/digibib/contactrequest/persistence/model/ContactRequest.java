...
package de.vzg.reposis.digibib.contactrequest.persistence.model;
...
public class ContactRequest {
    ...
    /**
     * Returns the list of contact attempt entries associated with the contact request.
     *
    ...
    /**
     * Sets the list of contact attempt entries associated with the contact request.
     *
