...
import de.vzg.reposis.digibib.agreement.config.AgreementConfig;
...
public class AuthorServiceProvider {
    ...
    public static AuthorServiceProvider createInstance() {
        return MCRConfiguration2
            .<AuthorServiceProvider>getInstanceOf(AgreementConfig.CONFIG_PREFIX + "AuthorServiceProvider.Class")
            .orElseThrow();
    }
