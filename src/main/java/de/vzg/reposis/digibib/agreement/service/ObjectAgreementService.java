...
import de.vzg.reposis.digibib.agreement.factory.AgreementJsonMapper;
...
public class ObjectAgreementService {
    ...
    private static final String AGREEMENT_FLAG = "confirmedAgreement";
    ...
    private final AgreementJsonMapper mapper;
     ...
     */
    public ObjectAgreementService(AgreementJsonMapper mapper) {
        this.mapper = mapper;
    }
    ...
    public static ObjectAgreementService createInstance() {
        return new ObjectAgreementService(AgreementJsonMapper.obtainInstance());
    }
