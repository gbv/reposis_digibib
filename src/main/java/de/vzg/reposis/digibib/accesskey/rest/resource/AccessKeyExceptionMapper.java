...
/**
 * {@link ExceptionMapper} to handle {@link Exception}.
 */
@Provider
public class AccessKeyExceptionMapper implements ExceptionMapper<MCRAccessKeyException> {

    @Context
    Request request;

    @Override
    public Response toResponse(MCRAccessKeyException e) {
