...
package de.vzg.reposis.digibib.accesskey.exception;
 ...
 */
public class AccessKeyValidationException extends MCRAccessKeyException {
     ...
     */
    public AccessKeyValidationException(String errorMessage) {
        super(errorMessage);
    }
